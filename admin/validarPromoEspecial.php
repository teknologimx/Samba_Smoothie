...
// if everything is ok, try to upload file
    ...
    $query2 = "INSERT INTO promocion_especial (id_promo, id_promocion, tematica, categoria_p1, tipo_p1, producto_p1, categoria_p2, tipo_p2, producto_p2, descuento)
                  VALUES ('', '$id_p', '$tematica', '$cat', '$tipo', '$producto', '$cat2', '$tipo2', '$producto2', $descuento )";
    mysqli_query($link, $query2) or die(mysql_error($link));
    echo "Se agrego el reactivo exitosamente";
	
    }
    mysqli_close($link);
    header("Location: promoespecial.php");
?>
