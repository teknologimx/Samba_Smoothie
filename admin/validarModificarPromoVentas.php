<?php session_start();
   ...
   $img_promon=$row_promo["img_promo"];
    ...
    $query2="UPDATE promocion_ventas SET categoria_p1='$cat', tipo_p1='$tipo', producto_p1='$producto', categoria_p2 = '$cat2', tipo_p2 = '$tipo2', producto_p2 = '$producto2', descuento = '$descuento' WHERE id_promocion=$id_promocion";
